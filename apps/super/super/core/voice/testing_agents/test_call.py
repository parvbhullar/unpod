...
async def run_multi():
    res = await asyncio.gather(
        ...
        test_call_with_task("T8e16ed8d0bd311f1aaea14b5cd48690a"),
        test_call_with_task("Tefe4015f78de11f082ac156368e7acc4"),
        test_call_with_task("T83ab60e7f8df11f0878d43cd8a99e069"),
        test_call_with_task("Ta6ab7dad0b2211f1b6bd16b5cd486909"),
    )
...
if __name__ == "__main__":
    ...
    if args.multi:
        ...
        asyncio.run(test_call_with_task("T21116e040d5611f1a43f363a8e263234"))
